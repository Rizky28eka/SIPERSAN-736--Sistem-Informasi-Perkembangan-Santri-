...
<div class="mb-6 max-w-2xl mx-auto">
    ...
    <h3 class="text-xl font-bold text-slate-800">Edit Data Wali Santri</h3>
</div>
...
<div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 max-w-2xl mx-auto">
    <form action="<?= base_url('kepala/wali/update/' . $wali['id']) ?>" method="post" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value="<?= old('name', $wali['name']) ?>" 
        ...
        <div>
            ...
            <input type="text" name="username" id="username" value="<?= old('username', $wali['username']) ?>" 
                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-slate-600"
        ...
        <div>
            <label for="password" class="block text-sm font-semibold text-slate-700 mb-2">Password (Kosongkan jika tidak diganti)</label>
