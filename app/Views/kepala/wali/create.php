    ...
    <form action="<?= base_url('kepala/wali/store') ?>" method="post" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword('password', 'eyeIconWali')" id="eyeIconWali" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600">
