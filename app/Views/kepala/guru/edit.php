...
<div class="mb-6 max-w-2xl mx-auto">
    <a href="<?= base_url('kepala/guru') ?>" class="text-sm text-slate-500 hover:text-blue-600 flex items-center space-x-1 mb-2">
        <i data-lucide="arrow-left" class="w-4 h-4"></i>
        <span>Kembali ke Daftar</span>
    </a>
    <h3 class="text-xl font-bold text-slate-800">Edit Data Guru</h3>
</div>

<div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 max-w-2xl mx-auto">
    <form action="<?= base_url('kepala/guru/update/' . $guru['id']) ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="username" id="username" value="<?= old('username', $guru['username']) ?>" 
                    class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-slate-600"
